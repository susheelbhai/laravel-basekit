<x-layout.admin.app>
    ...
    <x-admin.page>
        <x-table.type.responsive title="Portfolio Detail">
            ...
            <x-table.element.tr>
                ...
                <x-table.element.td>
                    <img src="{{ asset($data->logo) }}" class="h-16 w-auto rounded-div object-contain" alt="">
                </x-table.element.td>
            </x-table.element.tr>
            <x-table.element.tr>
            ...
            <x-table.element.tr>
                <x-table.element.td colspan="2">
                    <div class="py-3">
                        <a href="{{ route('admin.portfolio.edit', $data['id']) }}"
