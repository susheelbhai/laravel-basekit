<x-layout.admin.app>
    ...
    <x-admin.page>
        <x-table.type.responsive title="Partner Detail">
            ...
            <x-table.element.tr>
                ...
                <x-table.element.td>
                    <img src="{{ $data['profile_pic'] }}" class="h-16 w-16 rounded-div object-cover" alt="">
                </x-table.element.td>
            </x-table.element.tr>
            ...
            <x-table.element.tr>
                <x-table.element.td colspan="2">
                    <div class="py-3">
                        <a href="{{ route('admin.partner.edit', $data['id']) }}"
