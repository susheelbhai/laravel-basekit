            ...
            <x-table.element.tbody>
                @forelse ($data as $i)
                    <x-table.element.tr>
                        ...
                        <x-table.element.td>
                            <img src="{{ asset($i->display_img) }}" class="h-8 w-8 rounded-div object-cover" alt="">
                        </x-table.element.td>
                        <x-table.element.td>
                            @if ($i->is_active == 1)
                        ...
                        <x-table.element.td>
                            <a href="{{ route('admin.service.show', $i->id) }}" class="inline-flex items-center gap-2 text-primary hover:underline">
                                View
                            </a>
                        </x-table.element.td>
                    </x-table.element.tr>
