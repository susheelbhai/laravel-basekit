<x-layout.admin.app>
    ...
    <x-admin.page>
        <x-form.type.standard title="Create User" action="{{ route('admin.user.store') }}" method="POST" submitName="Save">
            ...
            <x-form.element.input-img name="profile_pic" label="Profile Pic" type="image" div="6" ratio="125" />
