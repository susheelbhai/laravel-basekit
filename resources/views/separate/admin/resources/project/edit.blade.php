<x-layout.admin.app>
    ...
    <x-admin.page>
        <x-form.type.standard title="Edit Project" action="{{ route('admin.project.update', $data->id) }}" method="POST" submitName="Save">
            @method('patch')
            <x-form.element.input1 name="title" label="Title" type="text" required="required" :value="old('title', $data->title ?? '')" div="1" />
            <x-form.element.input1 name="author" label="Author" type="text" :value="old('author', $data->author ?? '')" div="1" />
            <x-form.element.input1 name="tags" label="Tags" type="tags" :value="old('tags', $data->tags ?? '')" div="1" />
            ...
            <x-form.element.input1 name="long_description1" label="Long Description 1" type="editor" :value="old('long_description1', $data->long_description1 ?? '')" div="1" />
            ...
            <x-form.element.input1 name="highlighted_text1" label="Highlighted Text 1" type="editor" :value="old('highlighted_text1', $data->highlighted_text1 ?? '')" div="1" />
            <x-form.element.input1 name="highlighted_text2" label="Highlighted Text 2" type="editor" :value="old('highlighted_text2', $data->highlighted_text2 ?? '')" div="1" />

            <x-form.element.input1 name="ad_url" label="Ad URL" type="url" :value="old('ad_url', $data->ad_url ?? '')" div="1" />
            <x-form.element.input1 name="views" label="Views" type="number" :value="old('views', $data->views ?? 0)" div="1" />
