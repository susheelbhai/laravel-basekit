@php
    $starterKitSidebarNav = include resource_path('data/php/partner_sidebar.php');
@endphp
<x-layout.app
    :sidebar-footer-nav-items="$starterKitSidebarNav['footerNavItems'] ?? []"
    :sidebar-profile-nav-items="$starterKitSidebarNav['profileNavItems'] ?? []"
    sidebar-user-guard="partner"
>
    <x-slot name='head'>
