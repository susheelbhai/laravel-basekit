...
return [
     ...
     */
    'max_file_size' => (int) env('MEDIA_MAX_FILE_SIZE', 1024 * 1024 * 25), // default 25MB

    /*
     * This queue connection will be used to generate derived and responsive images.
     * Use MEDIA_QUEUE_CONNECTION to override the app default (e.g. use "database" while QUEUE_CONNECTION is "sync").
     * Default matches config/queue.php so conversions are not forced onto the sync driver when QUEUE_CONNECTION is unset.
     */
