...
use Susheelbhai\Basekit\Commands\Helper\UpdateIndexFile;
use Susheelbhai\Basekit\Commands\Helper\UpdateAppServiceProvider;

class final_settings extends Command
{
    protected $signature = 'basekit:final_settings';
